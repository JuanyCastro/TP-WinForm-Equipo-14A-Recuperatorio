...
namespace negocio
{
    public class ArticuloNegocio
    {
        public List<Articulo> listar()
        {
            ...
            try
            {
                datos.setearConsulta("SELECT Codigo, Nombre, A.Descripcion, M.Descripcion Marca, C.Descripcion Categoria, A.IdMarca, A.IdCategoria, Precio, A.Id FROM ARTICULOS A, CATEGORIAS C, MARCAS M WHERE M.Id = IdMarca AND C.Id = IdCategoria");
        ...
        public List<Articulo> filtrar(string campo, string criterio, string filtro)
        {
            ...
            try
            {
                string consulta = "SELECT Codigo, Nombre, A.Descripcion, M.Descripcion Marca, C.Descripcion Categoria, A.IdMarca, A.IdCategoria, Precio, A.Id FROM ARTICULOS A, CATEGORIAS C, MARCAS M WHERE M.Id = IdMarca AND C.Id = IdCategoria And ";
